...
class catalogo : AppCompatActivity() {
    ...
    fun cargarPeliculas() {
        ...
        peliculas.add(Pelicula("Ghostbusters Apocalipsis", R.drawable.ghostbusters,R.drawable.ghostbusterss, "En Ghostbusters Apocalipsis Fantasma, regresa la familia Spengler a donde todo empezó – la icónica estación de bomberos en Nueva York – donde hace equipo junto con los Ghostbusters originales que han desarrollado un laboratorio de investigación ultrasecreto para llevar la cacería de fantasmas al siguiente nivel. Pero cuando el descubrimiento de un artefacto antiguo libera una fuerza maligna, los nuevos y viejos Ghostbusters unen sus fuerzas para proteger su hogar y salvar al mundo de una segunda era de hielo.",arrayListOf<Cliente>()))
        peliculas.add(Pelicula("Héroe por encargo", R.drawable.heroexencargos,R.drawable.heroexencargo, "Un ex agente de las fuerzas especiales acepta un trabajo para brindar seguridad a una periodista mientras entrevista a un dictador, pero estalla un golpe militar en medio de la entrevista y se ven obligados a escapar a la jungla donde deben sobrevivir.",arrayListOf<Cliente>()))
        ...
        peliculas.add(Pelicula("Vidas Pasadas", R.drawable.vidaspasadas,R.drawable.vidaspasadass, "Nora y Hae Sung, dos amigos de la infancia profundamente unidos, son separados después de que la familia de Nora emigrara de Corea del Sur. Veinte años después, se reúnen durante una fatídica semana para enfrentarse al amor y al destino.",arrayListOf<Cliente>()))
    }

    fun cargarSeries() {
        series.add(Pelicula("Avatar: La leyenda de Aang", R.drawable.avatars, R.drawable.avatar, "La leyenda de Aang sigue al último sobreviviente de los Nómadas del Aire, quien deberá restaurar el equilibrio en el mundo entre las tres naciones restantes: la Tribu del Agua, el Reino Tierra y la Nación del Fuego.",arrayListOf<Cliente>()))
        ...
        series.add(Pelicula("El Monstruo de la Vieja Séul", R.drawable.elmonstruo, R.drawable.elmounstruos, "Gyeongseong, 1945. En la oscura era colonial de Seúl, un empresario y una investigadora luchan por sobrevivir y se enfrentan a un monstruo nacido de la avaricia humana.",arrayListOf<Cliente>()))
